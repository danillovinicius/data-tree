...
requirejs.config({
    ...
    paths: {
        ...
        'angular'               : [bibliotecasDir + 'dist/angular.min'],
        'ngTable'               : [bibliotecasDir + '/src/ng-table/0.3.1/ng-table.min'],
        'restangular'           : [bibliotecasDir + '/src/restangular/1.3.1/restangular.min'],
        'ckeditor'              : [bibliotecasDir + '/src/ckeditor/4.4.3/ckeditor'],
        'd3'                    : [bibliotecasDir + '/src/d3/3.4.11/d3.min'],
